...
$string['eventsubmissionsubmitted'] = 'Submission submitted';
$string['eventturnitintoolcreated'] = 'Turnitintool created';
$string['eventturnitintooldeleted'] = 'Turnitintool deleted';
$string['eventturnitintoolupdated'] = 'Turnitintool updated';
...
$string['excludevaluepercenterror'] = 'When excluding small matches by percentage, you must enter a number between 1 and 100.';
...
$string['showreviewuploadoption'] = 'Enable Review Upload submission';
$string['showreviewuploadoptionhelp'] = 'Enable option to Review Upload before Submitting to Turnitin';
...
$string['turnitindeletegrade'] = 'Delete grade with submission';
$string['turnitindeletegrade_desc'] = 'If set to yes, when a submission is deleted, any corresponding grade will also be removed from the gradebook.';
...
$string['turnitintool:submitonbehalfof'] = 'Submit Turnitin Tool Assignments on behalf of other users';
$string['turnitintool:submitwhenloggedinas'] = 'Submit Turnitin Tool Assignments when \'logged in\' as other users';
